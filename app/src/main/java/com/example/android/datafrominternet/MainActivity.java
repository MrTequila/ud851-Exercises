...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        // COMPLETE Call getResponseFromHttpUrl and display the results in mSearchResultsTextView
        ...
        // COMPLETE Surround the call to getResponseFromHttpUrl with a try / catch block to catch an IOException
    }
